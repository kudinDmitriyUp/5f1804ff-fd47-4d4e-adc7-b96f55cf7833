...
export const metadata: Metadata = {
  title: "Jake Young's Estate - Luxury Real Estate",
  description: "Premium luxury real estate services. Browse featured properties, meet our expert agents, and find your dream home with Jake Young's Estate.",
  keywords: "luxury real estate, property sales, real estate agents, home buying, investment properties",
  metadataBase: new URL("https://jakeyoungestate.com"),
  alternates: {
    canonical: "https://jakeyoungestate.com"
  },
  openGraph: {
    title: "Jake Young's Estate - Premium Luxury Real Estate",
    description: "Discover luxury properties and expert real estate services. Browse our featured listings and connect with our professional team.",
    url: "https://jakeyoungestate.com",
    siteName: "Jake Young's Estate",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764667219290-gr3p367a.jpg",
  ...
  twitter: {
    ...
    title: "Jake Young's Estate - Luxury Real Estate",
    description: "Premium real estate services and luxury property listings.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764667219290-gr3p367a.jpg"]
  },
  robots: {
    index: true,
    follow: true
